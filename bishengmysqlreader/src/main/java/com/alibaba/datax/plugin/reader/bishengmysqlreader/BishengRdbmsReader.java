 ...
 * @author jake
 */
public class BishengRdbmsReader {
    ...
    public static class Job extends CommonRdbmsReader.Job {
        ...
        public List<Configuration> split(Configuration originalConfig, int adviceNumber) {
            return BishengReaderSplitUtil.doSplit(originalConfig, adviceNumber);
        }
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            // bisheng扩展: 验证bisheng专属参数
            // by jake.jin @2018-02-07
            validateBishengParameter(readerSliceConfig);
        ...
        protected Record transportOneRecord(RecordSender recordSender, ResultSet rs,
            ...
            Record record = buildRecord(recordSender, rs, metaData, columnNumber, mandatoryEncoding, taskPluginCollector, readerSliceConfig);
        ...
        protected Record buildRecord(RecordSender recordSender, ResultSet rs,
            ...
            Integer partition = readerSliceConfig.getInt(BishengConstant.BISHENG_TABLE_PARTITION);

            record.addColumn(new StringColumn(instance));
            record.addColumn(new StringColumn(tableSchema));
            record.addColumn(new StringColumn(table));
            record.addColumn(new LongColumn(partition));
        ...
        private void validateBishengParameter(Configuration readerSliceConfig) {
            ...
            readerSliceConfig.getNecessaryValue(BishengConstant.BISHENG_TABLE_PARTITION, BishengMysqlReaderErrorCode.REQUIRED_VALUE_INTERNAL_ERROR);
        }
    }
